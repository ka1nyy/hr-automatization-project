"""Add frontend-backed operational, leave, and hiring workflows.

Revision ID: 0002_integrated_workflows
Revises: 0001_module1_initial
...
revision: str = "0002_integrated_workflows"
down_revision: str | None = "0001_module1_initial"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("audit_log", postgresql.JSONB(), nullable=False, server_default=sa.text("'[]'::jsonb")),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.func.now()),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.func.now()),
        sa.Column("revision", sa.Integer(), nullable=False, server_default="1"),
    )
    op.create_index("ix_correspondence_status_due", "correspondence_items", ["status", "due_date"])
    op.create_index("ix_correspondence_sender_number", "correspondence_items", ["sender", "sender_number"])
    op.create_table(
        "work_tasks",
        sa.Column("id", sa.UUID(), primary_key=True),
    ...
    op.create_table(
        "leave_requests",
        sa.Column("id", sa.UUID(), primary_key=True),
        sa.Column("employee_id", sa.UUID(), sa.ForeignKey("employees.id", ondelete="RESTRICT"), nullable=False),
    ...
    op.create_index("ix_leave_employee_dates", "leave_requests", ["employee_id", "start_date", "end_date"])
