...
export default function OrganizationPage() {
  ...
  return <>
    <PageHeader eyebrow={`${department.departmentCode} · Organization Service`} title="Организация и назначения" description={department.isHrWorkspace ? 'Корпоративная структура, штат и кадровые назначения в доступном HR-контексте.' : 'Сотрудники, подразделения, роли и процессные назначения.'} actions={<button className="secondary-button"><Network size={16} /> Оргструктура</button>} />
