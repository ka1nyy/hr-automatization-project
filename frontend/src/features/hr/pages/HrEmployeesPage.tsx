...
export default function HrEmployeesPage() {
  ...
  return <>
    <HrSubnav />
    <PageHeader eyebrow="HR · Сотрудники" title="Каталог сотрудников" description="Штат, статусы занятости и полнота кадровых данных." actions={<><button className="secondary-button"><Download size={16} /> Экспорт</button><button className="primary-button"><UserPlus size={16} /> Новый сотрудник</button></>} />
