...
export const seedCorrespondence: Correspondence[] = [
  {
    ...
    subject: 'О предоставлении сведений по реализации социальных проектов за II квартал', summary: 'Запрошен консолидированный отчёт по проектам с разбивкой по регионам и сроком ответа до 17 июля.', documentType: 'Официальный запрос', channel: 'Государственный портал', department: 'Департамент экономического планирования', executive: 'А. С. Нурланов', executor: 'М. К. Садыкова', dueDate: '2026-07-17', priority: 'urgent', status: 'execution', workflowStep: 'Сбор заключений', confidentiality: 'internal', responseRequired: true,
...
export const seedTasks: WorkTask[] = [
  ...
  { id: 't-103', title: 'Проверить финансовые показатели отчёта', documentNumber: 'ВХ-2026-000842', process: 'Обработка входящего письма', role: 'Соисполнитель', department: 'Департамент экономического планирования', dueDate: '2026-07-15', priority: 'high', state: 'available' },
...
export const seedProcesses: ProcessDefinition[] = [
  { id: 'p-hr-leave', name: 'Согласование отпуска', version: 5, state: 'published', activeInstances: 9, owner: 'Департамент документооборота и управления персоналом', updatedAt: '2026-07-14', steps: ['Заявка', 'Руководитель', 'Проверка HR', 'Приказ', 'Календарь'] },
  { id: 'p-hr-change', name: 'Изменение данных сотрудника', version: 2, state: 'published', activeInstances: 4, owner: 'Департамент документооборота и управления персоналом', updatedAt: '2026-07-12', steps: ['Инициирование', 'Проверка HR', 'Согласование', 'Обновление HR Core'] },
  { id: 'p-hr-onboarding', name: 'Адаптация сотрудника', version: 3, state: 'published', activeInstances: 7, owner: 'Департамент документооборота и управления персоналом', updatedAt: '2026-07-10', steps: ['План адаптации', 'Доступы', 'Рабочее место', 'Контрольная встреча'] },
  ...
  { id: 'p-invest', name: 'Инвестиционное заключение', version: 3, state: 'draft', activeInstances: 0, owner: 'Департамент инвестиций', updatedAt: '2026-07-14', steps: ['Инициатор', 'Аналитик', 'Экономика', 'Риск', 'Комитет'] },
...
export const seedEmployees: Employee[] = [
  ...
  { id: 'e-3', name: 'Мадина Садыкова', initials: 'МС', role: 'Главный эксперт', department: 'Департамент экономического планирования', candidateGroups: ['strategy-executors'], status: 'active' },
  ...
  { id: 'e-5', name: 'Руслан Ибраев', initials: 'РИ', role: 'Директор департамента', department: 'Департамент экономического планирования', candidateGroups: ['economic-approvers'], status: 'acting' },
